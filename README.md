...
- TINYCPU_compiler_in_python.py : 
    └──gets the c like code address and generate the stack-assembly 
- TINYCPU_assembler_in_python.py
    └──gets the stack-assembly and generates the binary of it
- TINYCPU_mac2mem_in_python.py
    └──gets the binary of the code and turns it into the format of the verilog memory initialization format 
- TINYCPU_toolchain_controler.py
    └──connect all the 3 codes above for ease of use,it only need path of the c like code and does everything needed
