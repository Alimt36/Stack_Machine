...
module ram(clk, load, addr, d, q);
 ...
 initial begin
    ...
    mem[12'b000000000001] = 16'b0011000000101110 ;
    mem[12'b000000000010] = 16'b0001000000000000 ;
    mem[12'b000000000011] = 16'b0011000000101111 ;
    mem[12'b000000000100] = 16'b0001000000000000 ;
    mem[12'b000000000101] = 16'b0011000000110000 ;
    mem[12'b000000000110] = 16'b0001000000000000 ;
    mem[12'b000000000111] = 16'b0011000000110001 ;
    mem[12'b000000001000] = 16'b0001000000000000 ;
    mem[12'b000000001001] = 16'b0011000000110010 ;
    mem[12'b000000001010] = 16'b0001000000000000 ;
    mem[12'b000000001011] = 16'b0011000000110011 ;
    mem[12'b000000001100] = 16'b0001000001000000 ;
    mem[12'b000000001101] = 16'b0011000000110000 ;
    mem[12'b000000001110] = 16'b0001000000000010 ;
    mem[12'b000000001111] = 16'b0011000000110010 ;
    mem[12'b000000010000] = 16'b0001000001001000 ;
    mem[12'b000000010001] = 16'b0010000000110010 ;
    mem[12'b000000010010] = 16'b1000000000101111 ;
    mem[12'b000000010011] = 16'b0001000000000000 ;
    mem[12'b000000010100] = 16'b0011000000110010 ;
    mem[12'b000000010101] = 16'b0010000000110010 ;
    mem[12'b000000010110] = 16'b0001000000000011 ;
    mem[12'b000000010111] = 16'b1111000000001111 ;
    mem[12'b000000011000] = 16'b0101000000100011 ;
    mem[12'b000000011001] = 16'b0010000000110010 ;
    mem[12'b000000011010] = 16'b0111000000101111 ;
    mem[12'b000000011011] = 16'b0011000000110011 ;
    mem[12'b000000011100] = 16'b0010000000110011 ;
    mem[12'b000000011101] = 16'b1110000000000000 ;
    mem[12'b000000011110] = 16'b0010000000110010 ;
    mem[12'b000000011111] = 16'b0001000000000001 ;
    mem[12'b000000100000] = 16'b1111000000000000 ;
    mem[12'b000000100001] = 16'b0011000000110010 ;
    mem[12'b000000100010] = 16'b0100000000010101 ;
    mem[12'b000000100011] = 16'b0001000000000010 ;
    mem[12'b000000100100] = 16'b0011000000110010 ;
    mem[12'b000000100101] = 16'b0010000000110010 ;
    mem[12'b000000100110] = 16'b0001000000000011 ;
    mem[12'b000000100111] = 16'b1111000000001011 ;
    mem[12'b000000101000] = 16'b0101000000101110 ;
    mem[12'b000000101001] = 16'b0010000000110000 ;
    mem[12'b000000101010] = 16'b0011000000110011 ;
    mem[12'b000000101011] = 16'b0010000000110011 ;
    mem[12'b000000101100] = 16'b0010000000110010 ;
    mem[12'b000000101101] = 16'b1000000000101111 ;
    mem[12'b000000101110] = 16'b0000000000000000 ;
    mem[12'b000000101111] = 16'b0000000000000000 ;
    mem[12'b000000110000] = 16'b0000000000000000 ;
    mem[12'b000000110001] = 16'b0000000000000000 ;
    mem[12'b000000110010] = 16'b0000000000000000 ;
    mem[12'b000000110011] = 16'b0000000000000000 ;
 end
  ...
  always @(cs or irout or qtop)
    begin
      ...
      if(cs == `FETCHA)
        begin
          pcinc = 1; pc2abus = 1;
          // ir2dbus = 0; qtop2dbus = 0; alu2dbus = 0; ram2dbus = 0; in2dbus = 0;
        end
      else if(cs == `FETCHB)
        begin
        ...
        begin
          if(irout[15:12] == `PUSH)
            ...
            begin
              ind2abus = 1; ram2dbus = 1; dbus2qtop = 1; push = 1;
            end
